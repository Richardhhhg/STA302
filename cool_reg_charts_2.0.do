...
// label values SEL_IHE SEL_IHE_LABELS
// label values OCC_FATHER OCC_FATHER



// gen EDU_MOTHERxPEOPLE_HOUSE = EDU_MOTHER * PEOPLE_HOUSE
//
// global features MAT_S11 ENG_S11 CR_S11 CC_S11 BIO_S11 ib1.SEL_IHE REVENUE i.OCC_FATHER
global features MAT_S11 ENG_S11 CR_S11 CC_S11 BIO_S11 SEL_IHE_2 SEL_IHE_3 SEL_IHE_4 REVENUE OCC_FATHER_1 OCC_FATHER_2  OCC_FATHER_3  OCC_FATHER_4  OCC_FATHER_5 OCC_FATHER_6 OCC_FATHER_7 OCC_FATHER_8 OCC_FATHER_9 OCC_FATHER_10 
...
local notes "*SAY SOMETHING ABOUT THE REGRESSION TABLE HERE. DESCRIPTION DESCRIPTION DESCRIPTION DESCRIPTION!!!!!!!!!!!!* Standard errors are reported in parantheses below estimates. Significance stars are as follows: * p < 0.05, ** p < 0.01, *** p < 0.001."

esttab spec1 using akiuysgd.html, cells(b(star fmt(3)) se(fmt(3) par(( )))) title("Regression Results Table") addnotes("Notes:`notes'") stats(r2_a N, labels("Adjusted R-Squared" "Observations") fmt(3 0))label replace
